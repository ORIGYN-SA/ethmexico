...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      url: "https://rinkeby.infura.io/v3/5211016cda13428193ea4e4188862386", // <---- YOUR INFURA ID! (or it won't work)
    ...
    kovan: {
      url: "https://kovan.infura.io/v3/5211016cda13428193ea4e4188862386", // <---- YOUR INFURA ID! (or it won't work)
    ...
    mainnet: {
      url: "https://mainnet.infura.io/v3/5211016cda13428193ea4e4188862386", // <---- YOUR INFURA ID! (or it won't work)
    ...
    ropsten: {
      url: "https://ropsten.infura.io/v3/5211016cda13428193ea4e4188862386", // <---- YOUR INFURA ID! (or it won't work)
    ...
    goerli: {
      url: "https://goerli.infura.io/v3/5211016cda13428193ea4e4188862386", // <---- YOUR INFURA ID! (or it won't work)
